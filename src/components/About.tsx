        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            <div className="mt-8 p-6 bg-gradient-to-r from-primary/10 to-accent/10 rounded-lg border border-primary/20">
              <h3 className="text-xl font-bold text-foreground mb-3 text-center lg:text-left">Nos valeurs</h3>
              <ul className="space-y-2 text-foreground text-left inline-block">
          ...
          <div className="grid grid-cols-2 gap-6 mx-auto max-w-lg lg:mx-0">
